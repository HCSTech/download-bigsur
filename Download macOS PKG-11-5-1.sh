...
/usr/bin/curl -s "http://swcdn.apple.com/content/downloads/01/60/071-72781-A_CZ1D1FENMH/a09fvud3xxgih7qyau9a7lhtspho36mp0l/InstallAssistant.pkg" -o /private/tmp/InstallAssistant.pkg
